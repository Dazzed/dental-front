  ...
  render () {
    ...
    return (
      <form onSubmit={handleSubmit} className="form-horizontal">
        ...
        <FormGroup>
          <Col sm={12}>
            <Field name="accountHolder" type="checkbox" component="input" styleName="checkbox" />
            <span styleName="checkbox-label">Will their primary account holder be joining the membership</span>
          </Col>
        </FormGroup>
        <FormGroup>
          <Col sm={12}>
        ...
        <FormGroup>
          <Col sm={3}>
            <button type="submit" disabled={submitting} className="btn-bg btn-cyan btn-round btn-outline">Continue</button>
          </Col>
        </FormGroup>
      </form>
    );
