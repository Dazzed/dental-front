/*
Patient Reviewers List Component
================================================================================
*/
...
/*
Patient Reviewers List
================================================================================
*/
@CSSModules(styles, { allowMultiple: true })
class PatientReviewersList extends React.Component {
  ...
  */
  ...
  ------------------------------------------------------------
  */
  renderReviews (reviewer, reviews) {
  ...
  */
  render () {
    ...
    const patientRows = reviewers.map((patientReviews) => {
      const {
        reviewer,
        reviews
      } = patientReviews;
      ...
      const reviewRows = this.renderReviews(reviewer, reviews);
                    ...
                    <div styleName="controls">
                      <p>
                        <input
                          ...
                          styleName="button--wide"
                          value="ADD MEMBER"
                          onClick={this.onAddClick.bind(this, reviewer)}
                        />
                      </p>
                      <p>
                        <label>
                          <input
                            type="checkbox"
                            onChange={this.onCancelationFeeClick.bind(this, reviewer)}
                          />
                      ...
                      <p>
                        <label>
                          <input
                            type="checkbox"
                            onChange={this.onReEnrollmentFeeClick.bind(this, reviewer)}
                          />
...
export default PatientReviewersList;
