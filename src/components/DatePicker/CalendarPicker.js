// NOTE: edit to work with redux-form
// from https://github.com/pushtell/react-bootstrap-date-picker/blob/master/src/index.jsx
//
...
export default React.createClass({
  ...
  onChangeDate(newSelectedDate) {
    ...
    if(this.props.onBlur) {
      this.props.onBlur(newSelectedDate.toISOString());
    }
    if(this.props.onChange) {
